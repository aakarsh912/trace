    ...
    >
      ...
      >
        {(
            ...
            },
            {
              ...
              icon: (
                <svg
                  ...
                  style={{ width: 13, height: 13 }}
                >
                  <rect x="3" y="3" width="8" height="2" rx="0.5" />
                  <rect x="5" y="7" width="8" height="2" rx="0.5" />
          ...
          <button
            key={label}
            className={active ? "view-switcher-btn active" : "view-switcher-btn"}
          >
            {icon}
            {label}
          </button>
...
export default async function ProjectDetailPage({
  ...
  const submittedDeliverables = actionRows.reduce(
    (s, a) => s + a.submitted,
    0
  );
  const pendingDeliverables = actionRows.reduce((s, a) => s + a.pending, 0);
  const sentBackDeliverables = actionRows.reduce(
    (s, a) => s + a.sentBack,
    0
  );
